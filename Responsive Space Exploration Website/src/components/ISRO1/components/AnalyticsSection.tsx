...
const modelData: Record<string, ModelData> = {
  ...
  'xgboost': {
    ...
    insights:
      'XGBoost reveals that mission budget is the strongest predictor of success, with a non-linear relationship showing diminishing returns above ₹500 crores. Launch vehicle reliability metrics and historical success rates are heavily weighted. Communication satellites show 18% higher success rates compared to earth observation missions. The gradient boosting approach captures complex interactions between budget allocation and technical specifications.',
  },
  'logistic-regression': {
    ...
    insights:
      'The linear model shows that ISRO success rates have improved steadily over time, with a 2.3% increase per decade. GTO missions have 12% lower success probability compared to LEO missions due to complexity. PSLV demonstrates the most consistent positive coefficient. The simplicity of logistic regression makes it highly interpretable, showing clear linear relationships between technical parameters and mission outcomes.',
  },
};
            ...
            >
              <div className="relative bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  {/* ✅ SHAP Graph Image Display (Single shap.png) */}
<div className="relative mb-6 rounded-xl overflow-hidden bg-black/40 border border-cyan-500/30 aspect-video flex items-center justify-center group-hover:border-cyan-400/50 transition-colors duration-300">
